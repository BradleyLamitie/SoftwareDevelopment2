...
# Using GET 
$var_value = $_GET['id'];
# echo $var_value; SELECT picture,stuff_id, name, brand, color, loc_name, room,  lf_date, description, 
#	owner_finder, phone, email FROM stuff s INNER JOIN locations l ON s.stuff_id = l.loc_id WHERE stuff_id = 3;
