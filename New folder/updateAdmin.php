...
# What:  Limbo Lost & Found database - updateAdmin.php
# When:  Fall 2016 
...
<form action="updateAdminSearch.php"> <input type="text" name= "AdminSearch" 
	value="Admin email" /><input type="submit" value="Admin E-mail Search" class="centerButton" style="font-size:12px;"/></form>
<form action="login.php"><input class="centerButton" name="logout"  type="submit" 
	value="Logout" style="font-size:13px;"/></form>
