...
# This page, will use possibles.php to call a function called possible_matches.
# Other functions used by this page, are in limbo_functions.php.

session_start();
$_SESSION['status'] = "lost";
$_SESSION['last_page']="lost";
...
<form action="found.php"><input class="sideButton" id="button2" type="submit" value="Found Something?" style="text-align:left;" /></form>
...
{	
	...
	{		
		# Using possibles.php which contains this function to 
...
<!-- Display page heading.  -->
	...
	<form action="lost.php"  method="post">
		...
		<select name = "locations" id="locationsoflow">
		...
		<input name = "submitbutton"  action = "possible_matches()" type = "submit" value = "Submit-lost" class= "centerButton"/>
	</form>
<!-- -------------------------------------------- -->	
