...
<form action="login.php"><input class="sideButton" id="button3" type="submit" value="Admin Login" /></form>
...
{	
	...
	{ 
		...
		echo "The picture ". basename( $_FILES['uploadedfile']['name']). " and information 
		   on your item has been uploaded.  
		Please click one of the buttons at the bottom of the page.";
	} 
	else
	{ 
...
<input name = "submitButton" type = "submit" value = "Submit-add" class="centerButton" />
</form>		
