...
function possible_matches($dbc, $status, $name, $brand, $color, $lf_date, $location_id)
{
	...
	if( $results )
	{
		...
		{
			?>
			<form action = "lost.php"> <input type="submit" value="Back" class="centerButton"/> </form>
			<?php
		}
		else if ($last_page == "found")
		{
			?>
			<form action = "found.php"> <input type="submit" value="Back" class="centerButton"/> </form>
			<?php
		}
	...
	<!-- <form><input type="button" value="Back" onClick="history.go(-1);return true;"/></form> -->
		...
		<form action = "add_more.php"> <input type="submit" value="Continue" class="centerButton"/> </form> 
