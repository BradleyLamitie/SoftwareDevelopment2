...
<form action="updateAdminSearch.php"> 			<input type="text" name= "AdminSearch" value="Admin email" /><input type="submit" value="Admin E-mail Search" class="centerButton" style="font-size:12px;"/></form>
