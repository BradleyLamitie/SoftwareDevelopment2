...
<h1>Admin Info:</h1>
	...
	<p>Status: <select name = "superAdmin" id = "superAdmin" >superAdmin?</option>
					<option value =  "True"  <?php if($super_Admin === "true"){ echo('selected = "selected"');}?> >True</option>
					<option value =  "False" <?php if($super_Admin === "false"){ echo('selected = "selected"');}?>  > False </option>
				</select>	
<input type="submit" value="Delete Admin" name = "delete"/></form>
...
<form action="">	    <input type="submit" value="Limbo Home" /></form>
